...
/// L'import est le chemin de reprise depuis la version web : ces tests
/// s'exécutent sur une sauvegarde réellement produite par le bouton de
/// l'application, pas sur un JSON écrit pour l'occasion.
final class BackupTests: XCTestCase {
    ...
    func testDecodesRealWebBackup() throws {
    ...
    /// Réencoder puis relire ne doit rien perdre : c'est ce qui garantit
    /// qu'une sauvegarde faite par le natif se relira dans le navigateur.
