...
/// Lecture et écriture des sauvegardes de la version web.
///
/// C'est le chemin de reprise : quiconque a déjà tenu un carnet dans le
/// navigateur récupère ses rouleaux dans l'application native sans rien
/// ressaisir. Le format est le même dans les deux sens, ce qui laisse aussi la
/// porte ouverte au retour en arrière.
