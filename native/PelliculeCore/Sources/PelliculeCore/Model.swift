...
/// Modèle de données du carnet, décalqué de la version web.
///
/// Ce sont des structures Swift ordinaires, indépendantes de tout mécanisme de
/// persistance : elles se décodent depuis les sauvegardes JSON produites par la
/// version web, et serviront de socle aux entités SwiftData. Les séparer laisse
/// tout le domaine testable sur Linux, sans SDK Apple.
///
/// Les noms de champs suivent exactement ceux du JSON : une divergence ferait
/// perdre des données à l'import, sans erreur visible.
public enum Model {
