...
/// module, eux-mêmes engendrés depuis les sources TypeScript de la version web
/// par `tools/export-catalogs.mjs`. Une seule source de vérité, deux
/// applications : ce qu'un contributeur ajoute d'un côté arrive de l'autre.
public enum Catalog {
