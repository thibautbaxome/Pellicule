...
/// Ces tests vérifient que les banques se décodent telles qu'on les a écrites :
/// un champ renommé dans le JSON disparaîtrait silencieusement du modèle Swift,
/// sans erreur ni à la compilation ni à l'exécution.
