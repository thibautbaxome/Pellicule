...
perforations et le photogramme. Relancer ce script après toute modification :
...
def write_png(path, size):
    ...
    print(f"{path.relative_to(path.parents[2])} — {size}×{size}, {len(png)} octets")
...
def main():
    ...
    for size, name in [
        ...
        write_png(OUTPUT_DIR / name, size)
